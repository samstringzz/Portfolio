  ...
  ({
    ...
    useEffect(() => {
      ...
      function doResize() {
        ...
        const w = Math.max(rect.width, parent.clientWidth, 1);
        const h = Math.max(rect.height, parent.clientHeight, 1);
      ...
      function onMouseMove(e) {
        ...
        if (!parent) return;
        const rect = parent.getBoundingClientRect();
        // client coords stay accurate with sticky headers / scroll
      ...
      doResize();
      // Layout can settle after lazy-route mount; retry once more next frame
